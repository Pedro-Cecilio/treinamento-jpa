...
import com.dbserver.bug.bug2.domain.pessoa.Pessoa;
import com.dbserver.bug.bug2.domain.pessoa.PessoaRepository;
...
public class Bug2CommandLineRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Optional<Pessoa> sandro = this.pessoaRepository.buscarPessoaPeloNome("Sandro");
        if(sandro.isPresent()){
            logger.info("Sandro foi encontrado.");
        }
    }
